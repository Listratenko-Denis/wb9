...
btn.onclick = () => {
     ...
     discount.innerHTML = `${products[i].discountPercentage}%`
     ...
     card.append(title, thumbnail, description, price, discount, rating, stock, brand, category)
     wrapper.append(card)
...
// discount1.innerHTML = `${product.discountPercentage}%`
// rating.innerHTML = `rating is ${product.rating}`
